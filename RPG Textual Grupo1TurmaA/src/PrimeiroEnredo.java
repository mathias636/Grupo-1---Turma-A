...
public class PrimeiroEnredo {
    ...
    public static void main(Object args) throws Exception {
        ...
        do {
            ...
            if (choice == 1) {
                Digita("Escolha 1: Você escolheu as Montanhas do Amanhã, e infelizmente elas te levaram para um buraco sem fundo.",
                        TimeUnit.MILLISECONDS, temp_dialog);
                break;
            }
            if (choice == 2) {
                Digita("Escolha 2: Você escolheu a Ponte Travessa, e Devon conseguiu achar um atalho para chegar na Terra de Ninguém ",
                        TimeUnit.MILLISECONDS, temp_dialog);
            } else {
